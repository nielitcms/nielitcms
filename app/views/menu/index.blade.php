...
<div class="col-sm-12">
	...
	<h3>
		...
		<a title="Add Top Menu" href="{{url('admin/menu/create/top')}}" class="btn btn-success btn-xs pull-right">
	...
	<h3>
		...
		<a title="Add Top Menu" href="{{url('admin/menu/create/bottom')}}" class="btn btn-success btn-xs pull-right">
