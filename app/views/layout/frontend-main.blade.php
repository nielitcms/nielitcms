...
<head>
	...
	<script type="text/javascript" src="{{asset('lib/colorbox/jquery.colorbox-min.js')}}"></script>
	...
	<link type="text/css" href="{{asset('lib/colorbox/colorbox.css')}}" rel="stylesheet" />
</head>
...
<body>
	...
	<div class="main-area">
		<div class="container">
			<div class="row">
				<div class="col-md-3" id="main">@yield('content1')</div>
				<div class="col-md-3" id="main">@yield('content2')</div>
				<div class="col-md-3" id="main">@yield('content3')</div>
